...
type HttpSpdxInvalidAbstractClassObject struct {
    SHACLObjectBase

}


type HttpSpdxInvalidAbstractClassObjectType struct {
    SHACLTypeBase
}
var httpSpdxInvalidAbstractClassType HttpSpdxInvalidAbstractClassObjectType

func DecodeHttpSpdxInvalidAbstractClass (data any, path Path, context map[string]string) (Ref[HttpSpdxInvalidAbstractClass], error) {
    return DecodeRef[HttpSpdxInvalidAbstractClass](data, path, context, httpSpdxInvalidAbstractClassType)
}

func (self HttpSpdxInvalidAbstractClassObjectType) DecodeProperty(o SHACLObject, name string, value interface{}, path Path) (bool, error) {
    obj := o.(HttpSpdxInvalidAbstractClass)
    _ = obj
    switch name {
    default:
...
func (self HttpSpdxInvalidAbstractClassObjectType) Create() SHACLObject {
    return ConstructHttpSpdxInvalidAbstractClassObject(&HttpSpdxInvalidAbstractClassObject{})
}

func ConstructHttpSpdxInvalidAbstractClassObject(o *HttpSpdxInvalidAbstractClassObject) *HttpSpdxInvalidAbstractClassObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}

type HttpSpdxInvalidAbstractClass interface {
    SHACLObject
}


func MakeHttpSpdxInvalidAbstractClass() HttpSpdxInvalidAbstractClass {
    return ConstructHttpSpdxInvalidAbstractClassObject(&HttpSpdxInvalidAbstractClassObject{})
}

func MakeHttpSpdxInvalidAbstractClassRef() Ref[HttpSpdxInvalidAbstractClass] {
    o := MakeHttpSpdxInvalidAbstractClass()
    return MakeObjectRef[HttpSpdxInvalidAbstractClass](o)
}

func (self *HttpSpdxInvalidAbstractClassObject) Validate(path Path, handler ErrorHandler) bool {
    var valid bool = true
...
func (self *HttpSpdxInvalidAbstractClassObject) Walk(path Path, visit Visit) {
    self.SHACLObjectBase.Walk(path, visit)
}



func (self *HttpSpdxInvalidAbstractClassObject) EncodeProperties(data map[string]interface{}, path Path) error {
...
func (self AiEnergyConsumptionObjectType) Create() SHACLObject {
    return ConstructAiEnergyConsumptionObject(&AiEnergyConsumptionObject{})
}

func ConstructAiEnergyConsumptionObject(o *AiEnergyConsumptionObject) *AiEnergyConsumptionObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
...
func (self *AiEnergyConsumptionObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.aiFinetuningEnergyConsumption.IsSet() {
        data["ai_finetuningEnergyConsumption"] = EncodeList[Ref[AiEnergyConsumptionDescription]](self.aiFinetuningEnergyConsumption.Get(), path.PushPath("aiFinetuningEnergyConsumption"), aiEnergyConsumptionAiFinetuningEnergyConsumptionContext, EncodeRef[AiEnergyConsumptionDescription])
    }
    if self.aiInferenceEnergyConsumption.IsSet() {
        data["ai_inferenceEnergyConsumption"] = EncodeList[Ref[AiEnergyConsumptionDescription]](self.aiInferenceEnergyConsumption.Get(), path.PushPath("aiInferenceEnergyConsumption"), aiEnergyConsumptionAiInferenceEnergyConsumptionContext, EncodeRef[AiEnergyConsumptionDescription])
    }
    if self.aiTrainingEnergyConsumption.IsSet() {
        data["ai_trainingEnergyConsumption"] = EncodeList[Ref[AiEnergyConsumptionDescription]](self.aiTrainingEnergyConsumption.Get(), path.PushPath("aiTrainingEnergyConsumption"), aiEnergyConsumptionAiTrainingEnergyConsumptionContext, EncodeRef[AiEnergyConsumptionDescription])
    }
    return nil
}
...
func (self AiEnergyConsumptionDescriptionObjectType) Create() SHACLObject {
    return ConstructAiEnergyConsumptionDescriptionObject(&AiEnergyConsumptionDescriptionObject{})
}

func ConstructAiEnergyConsumptionDescriptionObject(o *AiEnergyConsumptionDescriptionObject) *AiEnergyConsumptionDescriptionObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
...
func (self *AiEnergyConsumptionDescriptionObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.aiEnergyQuantity.IsSet() {
        data["ai_energyQuantity"] = EncodeFloat(self.aiEnergyQuantity.Get(), path.PushPath("aiEnergyQuantity"), aiEnergyConsumptionDescriptionAiEnergyQuantityContext)
    }
    if self.aiEnergyUnit.IsSet() {
        data["ai_energyUnit"] = EncodeIRI(self.aiEnergyUnit.Get(), path.PushPath("aiEnergyUnit"), aiEnergyConsumptionDescriptionAiEnergyUnitContext)
    }
    return nil
}
...
func (self AiEnergyUnitTypeObjectType) Create() SHACLObject {
    return ConstructAiEnergyUnitTypeObject(&AiEnergyUnitTypeObject{})
}

func ConstructAiEnergyUnitTypeObject(o *AiEnergyUnitTypeObject) *AiEnergyUnitTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *AiEnergyUnitTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self AiSafetyRiskAssessmentTypeObjectType) Create() SHACLObject {
    return ConstructAiSafetyRiskAssessmentTypeObject(&AiSafetyRiskAssessmentTypeObject{})
}

func ConstructAiSafetyRiskAssessmentTypeObject(o *AiSafetyRiskAssessmentTypeObject) *AiSafetyRiskAssessmentTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *AiSafetyRiskAssessmentTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self AnnotationTypeObjectType) Create() SHACLObject {
    return ConstructAnnotationTypeObject(&AnnotationTypeObject{})
}

func ConstructAnnotationTypeObject(o *AnnotationTypeObject) *AnnotationTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *AnnotationTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self CreationInfoObjectType) Create() SHACLObject {
    return ConstructCreationInfoObject(&CreationInfoObject{})
}

func ConstructCreationInfoObject(o *CreationInfoObject) *CreationInfoObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
        validators := []Validator[string]{}
...
func (self *CreationInfoObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.comment.IsSet() {
        data["comment"] = EncodeString(self.comment.Get(), path.PushPath("comment"), creationInfoCommentContext)
    }
    if self.created.IsSet() {
        data["created"] = EncodeDateTime(self.created.Get(), path.PushPath("created"), creationInfoCreatedContext)
    }
    if self.createdBy.IsSet() {
        data["createdBy"] = EncodeList[Ref[Agent]](self.createdBy.Get(), path.PushPath("createdBy"), creationInfoCreatedByContext, EncodeRef[Agent])
    }
    if self.createdUsing.IsSet() {
        data["createdUsing"] = EncodeList[Ref[Tool]](self.createdUsing.Get(), path.PushPath("createdUsing"), creationInfoCreatedUsingContext, EncodeRef[Tool])
    }
    if self.specVersion.IsSet() {
        data["specVersion"] = EncodeString(self.specVersion.Get(), path.PushPath("specVersion"), creationInfoSpecVersionContext)
    }
    return nil
}
...
func (self DictionaryEntryObjectType) Create() SHACLObject {
    return ConstructDictionaryEntryObject(&DictionaryEntryObject{})
}

func ConstructDictionaryEntryObject(o *DictionaryEntryObject) *DictionaryEntryObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
        validators := []Validator[string]{}
...
func (self *DictionaryEntryObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.key.IsSet() {
        data["key"] = EncodeString(self.key.Get(), path.PushPath("key"), dictionaryEntryKeyContext)
    }
    if self.value.IsSet() {
        data["value"] = EncodeString(self.value.Get(), path.PushPath("value"), dictionaryEntryValueContext)
    }
    return nil
}
...
const ElementNoAssertionElement = "https://spdx.org/rdf/3.0.1/terms/Core/NoAssertionElement"
// An Individual Value for Element representing a set of Elements with

// cardinality (number/count) of zero.
const ElementNoneElement = "https://spdx.org/rdf/3.0.1/terms/Core/NoneElement"
...
func (self ElementObjectType) Create() SHACLObject {
    return ConstructElementObject(&ElementObject{})
}

func ConstructElementObject(o *ElementObject) *ElementObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
        validators := []Validator[string]{}
        o.comment = NewProperty[string]("comment", validators)
...
func (self *ElementObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.comment.IsSet() {
        data["comment"] = EncodeString(self.comment.Get(), path.PushPath("comment"), elementCommentContext)
    }
    if self.creationInfo.IsSet() {
        data["creationInfo"] = EncodeRef[CreationInfo](self.creationInfo.Get(), path.PushPath("creationInfo"), elementCreationInfoContext)
    }
    if self.description.IsSet() {
        data["description"] = EncodeString(self.description.Get(), path.PushPath("description"), elementDescriptionContext)
    }
    if self.extension.IsSet() {
        data["extension"] = EncodeList[Ref[ExtensionExtension]](self.extension.Get(), path.PushPath("extension"), elementExtensionContext, EncodeRef[ExtensionExtension])
    }
    if self.externalIdentifier.IsSet() {
        data["externalIdentifier"] = EncodeList[Ref[ExternalIdentifier]](self.externalIdentifier.Get(), path.PushPath("externalIdentifier"), elementExternalIdentifierContext, EncodeRef[ExternalIdentifier])
    }
    if self.externalRef.IsSet() {
        data["externalRef"] = EncodeList[Ref[ExternalRef]](self.externalRef.Get(), path.PushPath("externalRef"), elementExternalRefContext, EncodeRef[ExternalRef])
    }
    if self.name.IsSet() {
        data["name"] = EncodeString(self.name.Get(), path.PushPath("name"), elementNameContext)
    }
    if self.summary.IsSet() {
        data["summary"] = EncodeString(self.summary.Get(), path.PushPath("summary"), elementSummaryContext)
    }
    if self.verifiedUsing.IsSet() {
        data["verifiedUsing"] = EncodeList[Ref[IntegrityMethod]](self.verifiedUsing.Get(), path.PushPath("verifiedUsing"), elementVerifiedUsingContext, EncodeRef[IntegrityMethod])
    }
    return nil
}
...
func (self ElementCollectionObjectType) Create() SHACLObject {
    return ConstructElementCollectionObject(&ElementCollectionObject{})
}

func ConstructElementCollectionObject(o *ElementCollectionObject) *ElementCollectionObject {
    ConstructElementObject(&o.ElementObject)
    {
...
func (self *ElementCollectionObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.element.IsSet() {
        data["element"] = EncodeList[Ref[Element]](self.element.Get(), path.PushPath("element"), elementCollectionElementContext, EncodeRef[Element])
    }
    if self.profileConformance.IsSet() {
        data["profileConformance"] = EncodeList[string](self.profileConformance.Get(), path.PushPath("profileConformance"), elementCollectionProfileConformanceContext, EncodeIRI)
    }
    if self.rootElement.IsSet() {
        data["rootElement"] = EncodeList[Ref[Element]](self.rootElement.Get(), path.PushPath("rootElement"), elementCollectionRootElementContext, EncodeRef[Element])
    }
    return nil
}
...
func (self ExternalIdentifierObjectType) Create() SHACLObject {
    return ConstructExternalIdentifierObject(&ExternalIdentifierObject{})
}

func ConstructExternalIdentifierObject(o *ExternalIdentifierObject) *ExternalIdentifierObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
        validators := []Validator[string]{}
        o.comment = NewProperty[string]("comment", validators)
...
func (self *ExternalIdentifierObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.comment.IsSet() {
        data["comment"] = EncodeString(self.comment.Get(), path.PushPath("comment"), externalIdentifierCommentContext)
    }
    if self.externalIdentifierType.IsSet() {
        data["externalIdentifierType"] = EncodeIRI(self.externalIdentifierType.Get(), path.PushPath("externalIdentifierType"), externalIdentifierExternalIdentifierTypeContext)
    }
    if self.identifier.IsSet() {
        data["identifier"] = EncodeString(self.identifier.Get(), path.PushPath("identifier"), externalIdentifierIdentifierContext)
    }
    if self.identifierLocator.IsSet() {
        data["identifierLocator"] = EncodeList[string](self.identifierLocator.Get(), path.PushPath("identifierLocator"), externalIdentifierIdentifierLocatorContext, EncodeString)
    }
    if self.issuingAuthority.IsSet() {
        data["issuingAuthority"] = EncodeString(self.issuingAuthority.Get(), path.PushPath("issuingAuthority"), externalIdentifierIssuingAuthorityContext)
    }
    return nil
}
...
func (self ExternalIdentifierTypeObjectType) Create() SHACLObject {
    return ConstructExternalIdentifierTypeObject(&ExternalIdentifierTypeObject{})
}

func ConstructExternalIdentifierTypeObject(o *ExternalIdentifierTypeObject) *ExternalIdentifierTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *ExternalIdentifierTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self ExternalMapObjectType) Create() SHACLObject {
    return ConstructExternalMapObject(&ExternalMapObject{})
}

func ConstructExternalMapObject(o *ExternalMapObject) *ExternalMapObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
...
func (self *ExternalMapObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.definingArtifact.IsSet() {
        data["definingArtifact"] = EncodeRef[Artifact](self.definingArtifact.Get(), path.PushPath("definingArtifact"), externalMapDefiningArtifactContext)
    }
    if self.externalSpdxId.IsSet() {
        data["externalSpdxId"] = EncodeString(self.externalSpdxId.Get(), path.PushPath("externalSpdxId"), externalMapExternalSpdxIdContext)
    }
    if self.locationHint.IsSet() {
        data["locationHint"] = EncodeString(self.locationHint.Get(), path.PushPath("locationHint"), externalMapLocationHintContext)
    }
    if self.verifiedUsing.IsSet() {
        data["verifiedUsing"] = EncodeList[Ref[IntegrityMethod]](self.verifiedUsing.Get(), path.PushPath("verifiedUsing"), externalMapVerifiedUsingContext, EncodeRef[IntegrityMethod])
    }
    return nil
}
...
func (self ExternalRefObjectType) Create() SHACLObject {
    return ConstructExternalRefObject(&ExternalRefObject{})
}

func ConstructExternalRefObject(o *ExternalRefObject) *ExternalRefObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
        validators := []Validator[string]{}
        o.comment = NewProperty[string]("comment", validators)
...
func (self *ExternalRefObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.comment.IsSet() {
        data["comment"] = EncodeString(self.comment.Get(), path.PushPath("comment"), externalRefCommentContext)
    }
    if self.contentType.IsSet() {
        data["contentType"] = EncodeString(self.contentType.Get(), path.PushPath("contentType"), externalRefContentTypeContext)
    }
    if self.externalRefType.IsSet() {
        data["externalRefType"] = EncodeIRI(self.externalRefType.Get(), path.PushPath("externalRefType"), externalRefExternalRefTypeContext)
    }
    if self.locator.IsSet() {
        data["locator"] = EncodeList[string](self.locator.Get(), path.PushPath("locator"), externalRefLocatorContext, EncodeString)
    }
    return nil
}
...
func (self ExternalRefTypeObjectType) Create() SHACLObject {
    return ConstructExternalRefTypeObject(&ExternalRefTypeObject{})
}

func ConstructExternalRefTypeObject(o *ExternalRefTypeObject) *ExternalRefTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *ExternalRefTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self HashAlgorithmObjectType) Create() SHACLObject {
    return ConstructHashAlgorithmObject(&HashAlgorithmObject{})
}

func ConstructHashAlgorithmObject(o *HashAlgorithmObject) *HashAlgorithmObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *HashAlgorithmObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self IntegrityMethodObjectType) Create() SHACLObject {
    return ConstructIntegrityMethodObject(&IntegrityMethodObject{})
}

func ConstructIntegrityMethodObject(o *IntegrityMethodObject) *IntegrityMethodObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
        validators := []Validator[string]{}
        o.comment = NewProperty[string]("comment", validators)
...
func (self *IntegrityMethodObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.comment.IsSet() {
        data["comment"] = EncodeString(self.comment.Get(), path.PushPath("comment"), integrityMethodCommentContext)
    }
    return nil
}
...
func (self LifecycleScopeTypeObjectType) Create() SHACLObject {
    return ConstructLifecycleScopeTypeObject(&LifecycleScopeTypeObject{})
}

func ConstructLifecycleScopeTypeObject(o *LifecycleScopeTypeObject) *LifecycleScopeTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *LifecycleScopeTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self NamespaceMapObjectType) Create() SHACLObject {
    return ConstructNamespaceMapObject(&NamespaceMapObject{})
}

func ConstructNamespaceMapObject(o *NamespaceMapObject) *NamespaceMapObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
        validators := []Validator[string]{}
...
func (self *NamespaceMapObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.namespace.IsSet() {
        data["namespace"] = EncodeString(self.namespace.Get(), path.PushPath("namespace"), namespaceMapNamespaceContext)
    }
    if self.prefix.IsSet() {
        data["prefix"] = EncodeString(self.prefix.Get(), path.PushPath("prefix"), namespaceMapPrefixContext)
    }
    return nil
}
...
func (self PackageVerificationCodeObjectType) Create() SHACLObject {
    return ConstructPackageVerificationCodeObject(&PackageVerificationCodeObject{})
}

func ConstructPackageVerificationCodeObject(o *PackageVerificationCodeObject) *PackageVerificationCodeObject {
    ConstructIntegrityMethodObject(&o.IntegrityMethodObject)
    {
        validators := []Validator[string]{}
        validators = append(validators,
            EnumValidator{[]string{
...
func (self *PackageVerificationCodeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.IntegrityMethodObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.algorithm.IsSet() {
        data["algorithm"] = EncodeIRI(self.algorithm.Get(), path.PushPath("algorithm"), packageVerificationCodeAlgorithmContext)
    }
    if self.hashValue.IsSet() {
        data["hashValue"] = EncodeString(self.hashValue.Get(), path.PushPath("hashValue"), packageVerificationCodeHashValueContext)
    }
    if self.packageVerificationCodeExcludedFile.IsSet() {
        data["packageVerificationCodeExcludedFile"] = EncodeList[string](self.packageVerificationCodeExcludedFile.Get(), path.PushPath("packageVerificationCodeExcludedFile"), packageVerificationCodePackageVerificationCodeExcludedFileContext, EncodeString)
    }
    return nil
}
...
func (self PositiveIntegerRangeObjectType) Create() SHACLObject {
    return ConstructPositiveIntegerRangeObject(&PositiveIntegerRangeObject{})
}

func ConstructPositiveIntegerRangeObject(o *PositiveIntegerRangeObject) *PositiveIntegerRangeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
...
func (self *PositiveIntegerRangeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.beginIntegerRange.IsSet() {
        data["beginIntegerRange"] = EncodeInteger(self.beginIntegerRange.Get(), path.PushPath("beginIntegerRange"), positiveIntegerRangeBeginIntegerRangeContext)
    }
    if self.endIntegerRange.IsSet() {
        data["endIntegerRange"] = EncodeInteger(self.endIntegerRange.Get(), path.PushPath("endIntegerRange"), positiveIntegerRangeEndIntegerRangeContext)
    }
    return nil
}
...
func (self PresenceTypeObjectType) Create() SHACLObject {
    return ConstructPresenceTypeObject(&PresenceTypeObject{})
}

func ConstructPresenceTypeObject(o *PresenceTypeObject) *PresenceTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *PresenceTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self ProfileIdentifierTypeObjectType) Create() SHACLObject {
    return ConstructProfileIdentifierTypeObject(&ProfileIdentifierTypeObject{})
}

func ConstructProfileIdentifierTypeObject(o *ProfileIdentifierTypeObject) *ProfileIdentifierTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *ProfileIdentifierTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self RelationshipObjectType) Create() SHACLObject {
    return ConstructRelationshipObject(&RelationshipObject{})
}

func ConstructRelationshipObject(o *RelationshipObject) *RelationshipObject {
    ConstructElementObject(&o.ElementObject)
    {
        validators := []Validator[string]{}
        validators = append(validators,
...
func (self *RelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.completeness.IsSet() {
        data["completeness"] = EncodeIRI(self.completeness.Get(), path.PushPath("completeness"), relationshipCompletenessContext)
    }
    if self.endTime.IsSet() {
        data["endTime"] = EncodeDateTime(self.endTime.Get(), path.PushPath("endTime"), relationshipEndTimeContext)
    }
    if self.from.IsSet() {
        data["from"] = EncodeRef[Element](self.from.Get(), path.PushPath("from"), relationshipFromContext)
    }
    if self.relationshipType.IsSet() {
        data["relationshipType"] = EncodeIRI(self.relationshipType.Get(), path.PushPath("relationshipType"), relationshipRelationshipTypeContext)
    }
    if self.startTime.IsSet() {
        data["startTime"] = EncodeDateTime(self.startTime.Get(), path.PushPath("startTime"), relationshipStartTimeContext)
    }
    if self.to.IsSet() {
        data["to"] = EncodeList[Ref[Element]](self.to.Get(), path.PushPath("to"), relationshipToContext, EncodeRef[Element])
    }
    return nil
}
...
func (self RelationshipCompletenessObjectType) Create() SHACLObject {
    return ConstructRelationshipCompletenessObject(&RelationshipCompletenessObject{})
}

func ConstructRelationshipCompletenessObject(o *RelationshipCompletenessObject) *RelationshipCompletenessObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *RelationshipCompletenessObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self RelationshipTypeObjectType) Create() SHACLObject {
    return ConstructRelationshipTypeObject(&RelationshipTypeObject{})
}

func ConstructRelationshipTypeObject(o *RelationshipTypeObject) *RelationshipTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *RelationshipTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self SpdxDocumentObjectType) Create() SHACLObject {
    return ConstructSpdxDocumentObject(&SpdxDocumentObject{})
}

func ConstructSpdxDocumentObject(o *SpdxDocumentObject) *SpdxDocumentObject {
    ConstructElementCollectionObject(&o.ElementCollectionObject)
    {
...
func (self *SpdxDocumentObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementCollectionObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.dataLicense.IsSet() {
        data["dataLicense"] = EncodeRef[SimplelicensingAnyLicenseInfo](self.dataLicense.Get(), path.PushPath("dataLicense"), spdxDocumentDataLicenseContext)
    }
    if self.import_.IsSet() {
        data["import"] = EncodeList[Ref[ExternalMap]](self.import_.Get(), path.PushPath("import_"), spdxDocumentImportContext, EncodeRef[ExternalMap])
    }
    if self.namespaceMap.IsSet() {
        data["namespaceMap"] = EncodeList[Ref[NamespaceMap]](self.namespaceMap.Get(), path.PushPath("namespaceMap"), spdxDocumentNamespaceMapContext, EncodeRef[NamespaceMap])
    }
    return nil
}
...
func (self SupportTypeObjectType) Create() SHACLObject {
    return ConstructSupportTypeObject(&SupportTypeObject{})
}

func ConstructSupportTypeObject(o *SupportTypeObject) *SupportTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *SupportTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self ToolObjectType) Create() SHACLObject {
    return ConstructToolObject(&ToolObject{})
}

func ConstructToolObject(o *ToolObject) *ToolObject {
    ConstructElementObject(&o.ElementObject)
    return o
}
...
func (self *ToolObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self DatasetConfidentialityLevelTypeObjectType) Create() SHACLObject {
    return ConstructDatasetConfidentialityLevelTypeObject(&DatasetConfidentialityLevelTypeObject{})
}

func ConstructDatasetConfidentialityLevelTypeObject(o *DatasetConfidentialityLevelTypeObject) *DatasetConfidentialityLevelTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *DatasetConfidentialityLevelTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self DatasetDatasetAvailabilityTypeObjectType) Create() SHACLObject {
    return ConstructDatasetDatasetAvailabilityTypeObject(&DatasetDatasetAvailabilityTypeObject{})
}

func ConstructDatasetDatasetAvailabilityTypeObject(o *DatasetDatasetAvailabilityTypeObject) *DatasetDatasetAvailabilityTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *DatasetDatasetAvailabilityTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self DatasetDatasetTypeObjectType) Create() SHACLObject {
    return ConstructDatasetDatasetTypeObject(&DatasetDatasetTypeObject{})
}

func ConstructDatasetDatasetTypeObject(o *DatasetDatasetTypeObject) *DatasetDatasetTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *DatasetDatasetTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self ExpandedlicensingLicenseAdditionObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingLicenseAdditionObject(&ExpandedlicensingLicenseAdditionObject{})
}

func ConstructExpandedlicensingLicenseAdditionObject(o *ExpandedlicensingLicenseAdditionObject) *ExpandedlicensingLicenseAdditionObject {
    ConstructElementObject(&o.ElementObject)
    {
        validators := []Validator[string]{}
...
func (self *ExpandedlicensingLicenseAdditionObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.expandedlicensingAdditionText.IsSet() {
        data["expandedlicensing_additionText"] = EncodeString(self.expandedlicensingAdditionText.Get(), path.PushPath("expandedlicensingAdditionText"), expandedlicensingLicenseAdditionExpandedlicensingAdditionTextContext)
    }
    if self.expandedlicensingIsDeprecatedAdditionId.IsSet() {
        data["expandedlicensing_isDeprecatedAdditionId"] = EncodeBoolean(self.expandedlicensingIsDeprecatedAdditionId.Get(), path.PushPath("expandedlicensingIsDeprecatedAdditionId"), expandedlicensingLicenseAdditionExpandedlicensingIsDeprecatedAdditionIdContext)
    }
    if self.expandedlicensingLicenseXml.IsSet() {
        data["expandedlicensing_licenseXml"] = EncodeString(self.expandedlicensingLicenseXml.Get(), path.PushPath("expandedlicensingLicenseXml"), expandedlicensingLicenseAdditionExpandedlicensingLicenseXmlContext)
    }
    if self.expandedlicensingObsoletedBy.IsSet() {
        data["expandedlicensing_obsoletedBy"] = EncodeString(self.expandedlicensingObsoletedBy.Get(), path.PushPath("expandedlicensingObsoletedBy"), expandedlicensingLicenseAdditionExpandedlicensingObsoletedByContext)
    }
    if self.expandedlicensingSeeAlso.IsSet() {
        data["expandedlicensing_seeAlso"] = EncodeList[string](self.expandedlicensingSeeAlso.Get(), path.PushPath("expandedlicensingSeeAlso"), expandedlicensingLicenseAdditionExpandedlicensingSeeAlsoContext, EncodeString)
    }
    if self.expandedlicensingStandardAdditionTemplate.IsSet() {
        data["expandedlicensing_standardAdditionTemplate"] = EncodeString(self.expandedlicensingStandardAdditionTemplate.Get(), path.PushPath("expandedlicensingStandardAdditionTemplate"), expandedlicensingLicenseAdditionExpandedlicensingStandardAdditionTemplateContext)
    }
    return nil
}
...
func (self ExpandedlicensingListedLicenseExceptionObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingListedLicenseExceptionObject(&ExpandedlicensingListedLicenseExceptionObject{})
}

func ConstructExpandedlicensingListedLicenseExceptionObject(o *ExpandedlicensingListedLicenseExceptionObject) *ExpandedlicensingListedLicenseExceptionObject {
    ConstructExpandedlicensingLicenseAdditionObject(&o.ExpandedlicensingLicenseAdditionObject)
    {
        validators := []Validator[string]{}
...
func (self *ExpandedlicensingListedLicenseExceptionObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ExpandedlicensingLicenseAdditionObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.expandedlicensingDeprecatedVersion.IsSet() {
        data["expandedlicensing_deprecatedVersion"] = EncodeString(self.expandedlicensingDeprecatedVersion.Get(), path.PushPath("expandedlicensingDeprecatedVersion"), expandedlicensingListedLicenseExceptionExpandedlicensingDeprecatedVersionContext)
    }
    if self.expandedlicensingListVersionAdded.IsSet() {
        data["expandedlicensing_listVersionAdded"] = EncodeString(self.expandedlicensingListVersionAdded.Get(), path.PushPath("expandedlicensingListVersionAdded"), expandedlicensingListedLicenseExceptionExpandedlicensingListVersionAddedContext)
    }
    return nil
}
...
func (self ExtensionCdxPropertyEntryObjectType) Create() SHACLObject {
    return ConstructExtensionCdxPropertyEntryObject(&ExtensionCdxPropertyEntryObject{})
}

func ConstructExtensionCdxPropertyEntryObject(o *ExtensionCdxPropertyEntryObject) *ExtensionCdxPropertyEntryObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    {
        validators := []Validator[string]{}
...
func (self *ExtensionCdxPropertyEntryObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.extensionCdxPropName.IsSet() {
        data["extension_cdxPropName"] = EncodeString(self.extensionCdxPropName.Get(), path.PushPath("extensionCdxPropName"), extensionCdxPropertyEntryExtensionCdxPropNameContext)
    }
    if self.extensionCdxPropValue.IsSet() {
        data["extension_cdxPropValue"] = EncodeString(self.extensionCdxPropValue.Get(), path.PushPath("extensionCdxPropValue"), extensionCdxPropertyEntryExtensionCdxPropValueContext)
    }
    return nil
}
...
func (self ExtensionExtensionObjectType) Create() SHACLObject {
    return ConstructExtensionExtensionObject(&ExtensionExtensionObject{})
}

func ConstructExtensionExtensionObject(o *ExtensionExtensionObject) *ExtensionExtensionObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *ExtensionExtensionObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
...
func (self SecurityCvssSeverityTypeObjectType) Create() SHACLObject {
    return ConstructSecurityCvssSeverityTypeObject(&SecurityCvssSeverityTypeObject{})
}

func ConstructSecurityCvssSeverityTypeObject(o *SecurityCvssSeverityTypeObject) *SecurityCvssSeverityTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *SecurityCvssSeverityTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self SecurityExploitCatalogTypeObjectType) Create() SHACLObject {
    return ConstructSecurityExploitCatalogTypeObject(&SecurityExploitCatalogTypeObject{})
}

func ConstructSecurityExploitCatalogTypeObject(o *SecurityExploitCatalogTypeObject) *SecurityExploitCatalogTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *SecurityExploitCatalogTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self SecuritySsvcDecisionTypeObjectType) Create() SHACLObject {
    return ConstructSecuritySsvcDecisionTypeObject(&SecuritySsvcDecisionTypeObject{})
}

func ConstructSecuritySsvcDecisionTypeObject(o *SecuritySsvcDecisionTypeObject) *SecuritySsvcDecisionTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *SecuritySsvcDecisionTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self SecurityVexJustificationTypeObjectType) Create() SHACLObject {
    return ConstructSecurityVexJustificationTypeObject(&SecurityVexJustificationTypeObject{})
}

func ConstructSecurityVexJustificationTypeObject(o *SecurityVexJustificationTypeObject) *SecurityVexJustificationTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *SecurityVexJustificationTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
type SecurityVulnAssessmentRelationshipObject struct {
    ...
    // found.
    securityAssessedElement RefProperty[Element]
...
func (self SecurityVulnAssessmentRelationshipObjectType) DecodeProperty(o SHACLObject, name string, value interface{}, path Path) (bool, error) {
    ...
    case "https://spdx.org/rdf/3.0.1/terms/Security/assessedElement", "security_assessedElement":
        val, err := DecodeElement(value, path, securityVulnAssessmentRelationshipSecurityAssessedElementContext)
        if err != nil {
            return false, err
        }
...
func (self SecurityVulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecurityVulnAssessmentRelationshipObject(&SecurityVulnAssessmentRelationshipObject{})
}

func ConstructSecurityVulnAssessmentRelationshipObject(o *SecurityVulnAssessmentRelationshipObject) *SecurityVulnAssessmentRelationshipObject {
    ConstructRelationshipObject(&o.RelationshipObject)
    {
        validators := []Validator[Ref[Agent]]{}
    ...
    {
        validators := []Validator[Ref[Element]]{}
        o.securityAssessedElement = NewRefProperty[Element]("securityAssessedElement", validators)
    }
    {
        validators := []Validator[time.Time]{}
        validators = append(validators, RegexValidator[time.Time]{`^\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\dZ$`})
...
type SecurityVulnAssessmentRelationship interface {
    ...
    SecurityAssessedElement() RefPropertyInterface[Element]
...
func (self *SecurityVulnAssessmentRelationshipObject) SecurityAssessedElement() RefPropertyInterface[Element] { return &self.securityAssessedElement }
...
func (self *SecurityVulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.RelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.suppliedBy.IsSet() {
        data["suppliedBy"] = EncodeRef[Agent](self.suppliedBy.Get(), path.PushPath("suppliedBy"), securityVulnAssessmentRelationshipSuppliedByContext)
    }
    if self.securityAssessedElement.IsSet() {
        data["security_assessedElement"] = EncodeRef[Element](self.securityAssessedElement.Get(), path.PushPath("securityAssessedElement"), securityVulnAssessmentRelationshipSecurityAssessedElementContext)
    }
    if self.securityModifiedTime.IsSet() {
        data["security_modifiedTime"] = EncodeDateTime(self.securityModifiedTime.Get(), path.PushPath("securityModifiedTime"), securityVulnAssessmentRelationshipSecurityModifiedTimeContext)
    }
    if self.securityPublishedTime.IsSet() {
        data["security_publishedTime"] = EncodeDateTime(self.securityPublishedTime.Get(), path.PushPath("securityPublishedTime"), securityVulnAssessmentRelationshipSecurityPublishedTimeContext)
    }
    if self.securityWithdrawnTime.IsSet() {
        data["security_withdrawnTime"] = EncodeDateTime(self.securityWithdrawnTime.Get(), path.PushPath("securityWithdrawnTime"), securityVulnAssessmentRelationshipSecurityWithdrawnTimeContext)
    }
    return nil
}
...
func (self SimplelicensingAnyLicenseInfoObjectType) Create() SHACLObject {
    return ConstructSimplelicensingAnyLicenseInfoObject(&SimplelicensingAnyLicenseInfoObject{})
}

func ConstructSimplelicensingAnyLicenseInfoObject(o *SimplelicensingAnyLicenseInfoObject) *SimplelicensingAnyLicenseInfoObject {
    ConstructElementObject(&o.ElementObject)
    return o
}
...
func (self *SimplelicensingAnyLicenseInfoObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self SimplelicensingLicenseExpressionObjectType) Create() SHACLObject {
    return ConstructSimplelicensingLicenseExpressionObject(&SimplelicensingLicenseExpressionObject{})
}

func ConstructSimplelicensingLicenseExpressionObject(o *SimplelicensingLicenseExpressionObject) *SimplelicensingLicenseExpressionObject {
    ConstructSimplelicensingAnyLicenseInfoObject(&o.SimplelicensingAnyLicenseInfoObject)
    {
...
func (self *SimplelicensingLicenseExpressionObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SimplelicensingAnyLicenseInfoObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.simplelicensingCustomIdToUri.IsSet() {
        data["simplelicensing_customIdToUri"] = EncodeList[Ref[DictionaryEntry]](self.simplelicensingCustomIdToUri.Get(), path.PushPath("simplelicensingCustomIdToUri"), simplelicensingLicenseExpressionSimplelicensingCustomIdToUriContext, EncodeRef[DictionaryEntry])
    }
    if self.simplelicensingLicenseExpression.IsSet() {
        data["simplelicensing_licenseExpression"] = EncodeString(self.simplelicensingLicenseExpression.Get(), path.PushPath("simplelicensingLicenseExpression"), simplelicensingLicenseExpressionSimplelicensingLicenseExpressionContext)
    }
    if self.simplelicensingLicenseListVersion.IsSet() {
        data["simplelicensing_licenseListVersion"] = EncodeString(self.simplelicensingLicenseListVersion.Get(), path.PushPath("simplelicensingLicenseListVersion"), simplelicensingLicenseExpressionSimplelicensingLicenseListVersionContext)
    }
    return nil
}
...
func (self SimplelicensingSimpleLicensingTextObjectType) Create() SHACLObject {
    return ConstructSimplelicensingSimpleLicensingTextObject(&SimplelicensingSimpleLicensingTextObject{})
}

func ConstructSimplelicensingSimpleLicensingTextObject(o *SimplelicensingSimpleLicensingTextObject) *SimplelicensingSimpleLicensingTextObject {
    ConstructElementObject(&o.ElementObject)
    {
        validators := []Validator[string]{}
...
func (self *SimplelicensingSimpleLicensingTextObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.simplelicensingLicenseText.IsSet() {
        data["simplelicensing_licenseText"] = EncodeString(self.simplelicensingLicenseText.Get(), path.PushPath("simplelicensingLicenseText"), simplelicensingSimpleLicensingTextSimplelicensingLicenseTextContext)
    }
    return nil
}
...
func (self SoftwareContentIdentifierObjectType) Create() SHACLObject {
    return ConstructSoftwareContentIdentifierObject(&SoftwareContentIdentifierObject{})
}

func ConstructSoftwareContentIdentifierObject(o *SoftwareContentIdentifierObject) *SoftwareContentIdentifierObject {
    ConstructIntegrityMethodObject(&o.IntegrityMethodObject)
    {
        validators := []Validator[string]{}
        validators = append(validators,
...
func (self *SoftwareContentIdentifierObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.IntegrityMethodObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.softwareContentIdentifierType.IsSet() {
        data["software_contentIdentifierType"] = EncodeIRI(self.softwareContentIdentifierType.Get(), path.PushPath("softwareContentIdentifierType"), softwareContentIdentifierSoftwareContentIdentifierTypeContext)
    }
    if self.softwareContentIdentifierValue.IsSet() {
        data["software_contentIdentifierValue"] = EncodeString(self.softwareContentIdentifierValue.Get(), path.PushPath("softwareContentIdentifierValue"), softwareContentIdentifierSoftwareContentIdentifierValueContext)
    }
    return nil
}
...
func (self SoftwareContentIdentifierTypeObjectType) Create() SHACLObject {
    return ConstructSoftwareContentIdentifierTypeObject(&SoftwareContentIdentifierTypeObject{})
}

func ConstructSoftwareContentIdentifierTypeObject(o *SoftwareContentIdentifierTypeObject) *SoftwareContentIdentifierTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *SoftwareContentIdentifierTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self SoftwareFileKindTypeObjectType) Create() SHACLObject {
    return ConstructSoftwareFileKindTypeObject(&SoftwareFileKindTypeObject{})
}

func ConstructSoftwareFileKindTypeObject(o *SoftwareFileKindTypeObject) *SoftwareFileKindTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *SoftwareFileKindTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self SoftwareSbomTypeObjectType) Create() SHACLObject {
    return ConstructSoftwareSbomTypeObject(&SoftwareSbomTypeObject{})
}

func ConstructSoftwareSbomTypeObject(o *SoftwareSbomTypeObject) *SoftwareSbomTypeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *SoftwareSbomTypeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self SoftwareSoftwarePurposeObjectType) Create() SHACLObject {
    return ConstructSoftwareSoftwarePurposeObject(&SoftwareSoftwarePurposeObject{})
}

func ConstructSoftwareSoftwarePurposeObject(o *SoftwareSoftwarePurposeObject) *SoftwareSoftwarePurposeObject {
    ConstructSHACLObjectBase(&o.SHACLObjectBase)
    return o
}
...
func (self *SoftwareSoftwarePurposeObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SHACLObjectBase.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self BuildBuildObjectType) Create() SHACLObject {
    return ConstructBuildBuildObject(&BuildBuildObject{})
}

func ConstructBuildBuildObject(o *BuildBuildObject) *BuildBuildObject {
    ConstructElementObject(&o.ElementObject)
    {
        validators := []Validator[time.Time]{}
        validators = append(validators, RegexValidator[time.Time]{`^\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\dZ$`})
...
func (self *BuildBuildObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.buildBuildEndTime.IsSet() {
        data["build_buildEndTime"] = EncodeDateTime(self.buildBuildEndTime.Get(), path.PushPath("buildBuildEndTime"), buildBuildBuildBuildEndTimeContext)
    }
    if self.buildBuildId.IsSet() {
        data["build_buildId"] = EncodeString(self.buildBuildId.Get(), path.PushPath("buildBuildId"), buildBuildBuildBuildIdContext)
    }
    if self.buildBuildStartTime.IsSet() {
        data["build_buildStartTime"] = EncodeDateTime(self.buildBuildStartTime.Get(), path.PushPath("buildBuildStartTime"), buildBuildBuildBuildStartTimeContext)
    }
    if self.buildBuildType.IsSet() {
        data["build_buildType"] = EncodeString(self.buildBuildType.Get(), path.PushPath("buildBuildType"), buildBuildBuildBuildTypeContext)
    }
    if self.buildConfigSourceDigest.IsSet() {
        data["build_configSourceDigest"] = EncodeList[Ref[Hash]](self.buildConfigSourceDigest.Get(), path.PushPath("buildConfigSourceDigest"), buildBuildBuildConfigSourceDigestContext, EncodeRef[Hash])
    }
    if self.buildConfigSourceEntrypoint.IsSet() {
        data["build_configSourceEntrypoint"] = EncodeList[string](self.buildConfigSourceEntrypoint.Get(), path.PushPath("buildConfigSourceEntrypoint"), buildBuildBuildConfigSourceEntrypointContext, EncodeString)
    }
    if self.buildConfigSourceUri.IsSet() {
        data["build_configSourceUri"] = EncodeList[string](self.buildConfigSourceUri.Get(), path.PushPath("buildConfigSourceUri"), buildBuildBuildConfigSourceUriContext, EncodeString)
    }
    if self.buildEnvironment.IsSet() {
        data["build_environment"] = EncodeList[Ref[DictionaryEntry]](self.buildEnvironment.Get(), path.PushPath("buildEnvironment"), buildBuildBuildEnvironmentContext, EncodeRef[DictionaryEntry])
    }
    if self.buildParameter.IsSet() {
        data["build_parameter"] = EncodeList[Ref[DictionaryEntry]](self.buildParameter.Get(), path.PushPath("buildParameter"), buildBuildBuildParameterContext, EncodeRef[DictionaryEntry])
    }
    return nil
}
...
func (self AgentObjectType) Create() SHACLObject {
    return ConstructAgentObject(&AgentObject{})
}

func ConstructAgentObject(o *AgentObject) *AgentObject {
    ConstructElementObject(&o.ElementObject)
    return o
}
...
func (self *AgentObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self AnnotationObjectType) Create() SHACLObject {
    return ConstructAnnotationObject(&AnnotationObject{})
}

func ConstructAnnotationObject(o *AnnotationObject) *AnnotationObject {
    ConstructElementObject(&o.ElementObject)
    {
        validators := []Validator[string]{}
        validators = append(validators,
...
func (self *AnnotationObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.annotationType.IsSet() {
        data["annotationType"] = EncodeIRI(self.annotationType.Get(), path.PushPath("annotationType"), annotationAnnotationTypeContext)
    }
    if self.contentType.IsSet() {
        data["contentType"] = EncodeString(self.contentType.Get(), path.PushPath("contentType"), annotationContentTypeContext)
    }
    if self.statement.IsSet() {
        data["statement"] = EncodeString(self.statement.Get(), path.PushPath("statement"), annotationStatementContext)
    }
    if self.subject.IsSet() {
        data["subject"] = EncodeRef[Element](self.subject.Get(), path.PushPath("subject"), annotationSubjectContext)
    }
    return nil
}
...
func (self ArtifactObjectType) Create() SHACLObject {
    return ConstructArtifactObject(&ArtifactObject{})
}

func ConstructArtifactObject(o *ArtifactObject) *ArtifactObject {
    ConstructElementObject(&o.ElementObject)
    {
        validators := []Validator[time.Time]{}
        validators = append(validators, RegexValidator[time.Time]{`^\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\dZ$`})
...
func (self *ArtifactObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.builtTime.IsSet() {
        data["builtTime"] = EncodeDateTime(self.builtTime.Get(), path.PushPath("builtTime"), artifactBuiltTimeContext)
    }
    if self.originatedBy.IsSet() {
        data["originatedBy"] = EncodeList[Ref[Agent]](self.originatedBy.Get(), path.PushPath("originatedBy"), artifactOriginatedByContext, EncodeRef[Agent])
    }
    if self.releaseTime.IsSet() {
        data["releaseTime"] = EncodeDateTime(self.releaseTime.Get(), path.PushPath("releaseTime"), artifactReleaseTimeContext)
    }
    if self.standardName.IsSet() {
        data["standardName"] = EncodeList[string](self.standardName.Get(), path.PushPath("standardName"), artifactStandardNameContext, EncodeString)
    }
    if self.suppliedBy.IsSet() {
        data["suppliedBy"] = EncodeRef[Agent](self.suppliedBy.Get(), path.PushPath("suppliedBy"), artifactSuppliedByContext)
    }
    if self.supportLevel.IsSet() {
        data["supportLevel"] = EncodeList[string](self.supportLevel.Get(), path.PushPath("supportLevel"), artifactSupportLevelContext, EncodeIRI)
    }
    if self.validUntilTime.IsSet() {
        data["validUntilTime"] = EncodeDateTime(self.validUntilTime.Get(), path.PushPath("validUntilTime"), artifactValidUntilTimeContext)
    }
    return nil
}
...
func (self BundleObjectType) Create() SHACLObject {
    return ConstructBundleObject(&BundleObject{})
}

func ConstructBundleObject(o *BundleObject) *BundleObject {
    ConstructElementCollectionObject(&o.ElementCollectionObject)
    {
        validators := []Validator[string]{}
...
func (self *BundleObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ElementCollectionObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.context.IsSet() {
        data["context"] = EncodeString(self.context.Get(), path.PushPath("context"), bundleContextContext)
    }
    return nil
}
...
func (self HashObjectType) Create() SHACLObject {
    return ConstructHashObject(&HashObject{})
}

func ConstructHashObject(o *HashObject) *HashObject {
    ConstructIntegrityMethodObject(&o.IntegrityMethodObject)
    {
        validators := []Validator[string]{}
        validators = append(validators,
...
func (self *HashObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.IntegrityMethodObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.algorithm.IsSet() {
        data["algorithm"] = EncodeIRI(self.algorithm.Get(), path.PushPath("algorithm"), hashAlgorithmContext)
    }
    if self.hashValue.IsSet() {
        data["hashValue"] = EncodeString(self.hashValue.Get(), path.PushPath("hashValue"), hashHashValueContext)
    }
    return nil
}
...
func (self LifecycleScopedRelationshipObjectType) Create() SHACLObject {
    return ConstructLifecycleScopedRelationshipObject(&LifecycleScopedRelationshipObject{})
}

func ConstructLifecycleScopedRelationshipObject(o *LifecycleScopedRelationshipObject) *LifecycleScopedRelationshipObject {
    ConstructRelationshipObject(&o.RelationshipObject)
    {
        validators := []Validator[string]{}
        validators = append(validators,
...
func (self *LifecycleScopedRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.RelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.scope.IsSet() {
        data["scope"] = EncodeIRI(self.scope.Get(), path.PushPath("scope"), lifecycleScopedRelationshipScopeContext)
    }
    return nil
}
...
func (self OrganizationObjectType) Create() SHACLObject {
    return ConstructOrganizationObject(&OrganizationObject{})
}

func ConstructOrganizationObject(o *OrganizationObject) *OrganizationObject {
    ConstructAgentObject(&o.AgentObject)
    return o
}
...
func (self *OrganizationObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.AgentObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
}
...
func (self PersonObjectType) Create() SHACLObject {
    return ConstructPersonObject(&PersonObject{})
}

func ConstructPersonObject(o *PersonObject) *PersonObject {
    ConstructAgentObject(&o.AgentObject)
    return o
}
...
func (self *PersonObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.AgentObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self SoftwareAgentObjectType) Create() SHACLObject {
    return ConstructSoftwareAgentObject(&SoftwareAgentObject{})
}

func ConstructSoftwareAgentObject(o *SoftwareAgentObject) *SoftwareAgentObject {
    ConstructAgentObject(&o.AgentObject)
    return o
}
...
func (self *SoftwareAgentObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.AgentObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self ExpandedlicensingConjunctiveLicenseSetObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingConjunctiveLicenseSetObject(&ExpandedlicensingConjunctiveLicenseSetObject{})
}

func ConstructExpandedlicensingConjunctiveLicenseSetObject(o *ExpandedlicensingConjunctiveLicenseSetObject) *ExpandedlicensingConjunctiveLicenseSetObject {
    ConstructSimplelicensingAnyLicenseInfoObject(&o.SimplelicensingAnyLicenseInfoObject)
    {
        validators := []Validator[Ref[SimplelicensingAnyLicenseInfo]]{}
...
func (self *ExpandedlicensingConjunctiveLicenseSetObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SimplelicensingAnyLicenseInfoObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.expandedlicensingMember.IsSet() {
        data["expandedlicensing_member"] = EncodeList[Ref[SimplelicensingAnyLicenseInfo]](self.expandedlicensingMember.Get(), path.PushPath("expandedlicensingMember"), expandedlicensingConjunctiveLicenseSetExpandedlicensingMemberContext, EncodeRef[SimplelicensingAnyLicenseInfo])
    }
    return nil
}
...
func (self ExpandedlicensingCustomLicenseAdditionObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingCustomLicenseAdditionObject(&ExpandedlicensingCustomLicenseAdditionObject{})
}

func ConstructExpandedlicensingCustomLicenseAdditionObject(o *ExpandedlicensingCustomLicenseAdditionObject) *ExpandedlicensingCustomLicenseAdditionObject {
    ConstructExpandedlicensingLicenseAdditionObject(&o.ExpandedlicensingLicenseAdditionObject)
    return o
}
...
func (self *ExpandedlicensingCustomLicenseAdditionObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ExpandedlicensingLicenseAdditionObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self ExpandedlicensingDisjunctiveLicenseSetObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingDisjunctiveLicenseSetObject(&ExpandedlicensingDisjunctiveLicenseSetObject{})
}

func ConstructExpandedlicensingDisjunctiveLicenseSetObject(o *ExpandedlicensingDisjunctiveLicenseSetObject) *ExpandedlicensingDisjunctiveLicenseSetObject {
    ConstructSimplelicensingAnyLicenseInfoObject(&o.SimplelicensingAnyLicenseInfoObject)
    {
        validators := []Validator[Ref[SimplelicensingAnyLicenseInfo]]{}
        o.expandedlicensingMember = NewRefListProperty[SimplelicensingAnyLicenseInfo]("expandedlicensingMember", validators)
...
func (self *ExpandedlicensingDisjunctiveLicenseSetObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SimplelicensingAnyLicenseInfoObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.expandedlicensingMember.IsSet() {
        data["expandedlicensing_member"] = EncodeList[Ref[SimplelicensingAnyLicenseInfo]](self.expandedlicensingMember.Get(), path.PushPath("expandedlicensingMember"), expandedlicensingDisjunctiveLicenseSetExpandedlicensingMemberContext, EncodeRef[SimplelicensingAnyLicenseInfo])
    }
    return nil
}
...
func (self ExpandedlicensingExtendableLicenseObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingExtendableLicenseObject(&ExpandedlicensingExtendableLicenseObject{})
}

func ConstructExpandedlicensingExtendableLicenseObject(o *ExpandedlicensingExtendableLicenseObject) *ExpandedlicensingExtendableLicenseObject {
    ConstructSimplelicensingAnyLicenseInfoObject(&o.SimplelicensingAnyLicenseInfoObject)
    return o
}
...
func (self *ExpandedlicensingExtendableLicenseObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SimplelicensingAnyLicenseInfoObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self ExpandedlicensingIndividualLicensingInfoObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingIndividualLicensingInfoObject(&ExpandedlicensingIndividualLicensingInfoObject{})
}

func ConstructExpandedlicensingIndividualLicensingInfoObject(o *ExpandedlicensingIndividualLicensingInfoObject) *ExpandedlicensingIndividualLicensingInfoObject {
    ConstructSimplelicensingAnyLicenseInfoObject(&o.SimplelicensingAnyLicenseInfoObject)
    return o
}
...
func (self *ExpandedlicensingIndividualLicensingInfoObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SimplelicensingAnyLicenseInfoObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self ExpandedlicensingLicenseObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingLicenseObject(&ExpandedlicensingLicenseObject{})
}

func ConstructExpandedlicensingLicenseObject(o *ExpandedlicensingLicenseObject) *ExpandedlicensingLicenseObject {
    ConstructExpandedlicensingExtendableLicenseObject(&o.ExpandedlicensingExtendableLicenseObject)
    {
        validators := []Validator[bool]{}
...
func (self *ExpandedlicensingLicenseObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ExpandedlicensingExtendableLicenseObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.expandedlicensingIsDeprecatedLicenseId.IsSet() {
        data["expandedlicensing_isDeprecatedLicenseId"] = EncodeBoolean(self.expandedlicensingIsDeprecatedLicenseId.Get(), path.PushPath("expandedlicensingIsDeprecatedLicenseId"), expandedlicensingLicenseExpandedlicensingIsDeprecatedLicenseIdContext)
    }
    if self.expandedlicensingIsFsfLibre.IsSet() {
        data["expandedlicensing_isFsfLibre"] = EncodeBoolean(self.expandedlicensingIsFsfLibre.Get(), path.PushPath("expandedlicensingIsFsfLibre"), expandedlicensingLicenseExpandedlicensingIsFsfLibreContext)
    }
    if self.expandedlicensingIsOsiApproved.IsSet() {
        data["expandedlicensing_isOsiApproved"] = EncodeBoolean(self.expandedlicensingIsOsiApproved.Get(), path.PushPath("expandedlicensingIsOsiApproved"), expandedlicensingLicenseExpandedlicensingIsOsiApprovedContext)
    }
    if self.expandedlicensingLicenseXml.IsSet() {
        data["expandedlicensing_licenseXml"] = EncodeString(self.expandedlicensingLicenseXml.Get(), path.PushPath("expandedlicensingLicenseXml"), expandedlicensingLicenseExpandedlicensingLicenseXmlContext)
    }
    if self.expandedlicensingObsoletedBy.IsSet() {
        data["expandedlicensing_obsoletedBy"] = EncodeString(self.expandedlicensingObsoletedBy.Get(), path.PushPath("expandedlicensingObsoletedBy"), expandedlicensingLicenseExpandedlicensingObsoletedByContext)
    }
    if self.expandedlicensingSeeAlso.IsSet() {
        data["expandedlicensing_seeAlso"] = EncodeList[string](self.expandedlicensingSeeAlso.Get(), path.PushPath("expandedlicensingSeeAlso"), expandedlicensingLicenseExpandedlicensingSeeAlsoContext, EncodeString)
    }
    if self.expandedlicensingStandardLicenseHeader.IsSet() {
        data["expandedlicensing_standardLicenseHeader"] = EncodeString(self.expandedlicensingStandardLicenseHeader.Get(), path.PushPath("expandedlicensingStandardLicenseHeader"), expandedlicensingLicenseExpandedlicensingStandardLicenseHeaderContext)
    }
    if self.expandedlicensingStandardLicenseTemplate.IsSet() {
        data["expandedlicensing_standardLicenseTemplate"] = EncodeString(self.expandedlicensingStandardLicenseTemplate.Get(), path.PushPath("expandedlicensingStandardLicenseTemplate"), expandedlicensingLicenseExpandedlicensingStandardLicenseTemplateContext)
    }
    if self.simplelicensingLicenseText.IsSet() {
        data["simplelicensing_licenseText"] = EncodeString(self.simplelicensingLicenseText.Get(), path.PushPath("simplelicensingLicenseText"), expandedlicensingLicenseSimplelicensingLicenseTextContext)
    }
    return nil
}
...
func (self ExpandedlicensingListedLicenseObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingListedLicenseObject(&ExpandedlicensingListedLicenseObject{})
}

func ConstructExpandedlicensingListedLicenseObject(o *ExpandedlicensingListedLicenseObject) *ExpandedlicensingListedLicenseObject {
    ConstructExpandedlicensingLicenseObject(&o.ExpandedlicensingLicenseObject)
    {
        validators := []Validator[string]{}
        o.expandedlicensingDeprecatedVersion = NewProperty[string]("expandedlicensingDeprecatedVersion", validators)
    }
...
func (self *ExpandedlicensingListedLicenseObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ExpandedlicensingLicenseObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.expandedlicensingDeprecatedVersion.IsSet() {
        data["expandedlicensing_deprecatedVersion"] = EncodeString(self.expandedlicensingDeprecatedVersion.Get(), path.PushPath("expandedlicensingDeprecatedVersion"), expandedlicensingListedLicenseExpandedlicensingDeprecatedVersionContext)
    }
    if self.expandedlicensingListVersionAdded.IsSet() {
        data["expandedlicensing_listVersionAdded"] = EncodeString(self.expandedlicensingListVersionAdded.Get(), path.PushPath("expandedlicensingListVersionAdded"), expandedlicensingListedLicenseExpandedlicensingListVersionAddedContext)
    }
    return nil
}
...
func (self ExpandedlicensingOrLaterOperatorObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingOrLaterOperatorObject(&ExpandedlicensingOrLaterOperatorObject{})
}

func ConstructExpandedlicensingOrLaterOperatorObject(o *ExpandedlicensingOrLaterOperatorObject) *ExpandedlicensingOrLaterOperatorObject {
    ConstructExpandedlicensingExtendableLicenseObject(&o.ExpandedlicensingExtendableLicenseObject)
    {
...
func (self *ExpandedlicensingOrLaterOperatorObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ExpandedlicensingExtendableLicenseObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.expandedlicensingSubjectLicense.IsSet() {
        data["expandedlicensing_subjectLicense"] = EncodeRef[ExpandedlicensingLicense](self.expandedlicensingSubjectLicense.Get(), path.PushPath("expandedlicensingSubjectLicense"), expandedlicensingOrLaterOperatorExpandedlicensingSubjectLicenseContext)
    }
    return nil
}
...
func (self ExpandedlicensingWithAdditionOperatorObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingWithAdditionOperatorObject(&ExpandedlicensingWithAdditionOperatorObject{})
}

func ConstructExpandedlicensingWithAdditionOperatorObject(o *ExpandedlicensingWithAdditionOperatorObject) *ExpandedlicensingWithAdditionOperatorObject {
    ConstructSimplelicensingAnyLicenseInfoObject(&o.SimplelicensingAnyLicenseInfoObject)
    {
...
func (self *ExpandedlicensingWithAdditionOperatorObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SimplelicensingAnyLicenseInfoObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.expandedlicensingSubjectAddition.IsSet() {
        data["expandedlicensing_subjectAddition"] = EncodeRef[ExpandedlicensingLicenseAddition](self.expandedlicensingSubjectAddition.Get(), path.PushPath("expandedlicensingSubjectAddition"), expandedlicensingWithAdditionOperatorExpandedlicensingSubjectAdditionContext)
    }
    if self.expandedlicensingSubjectExtendableLicense.IsSet() {
        data["expandedlicensing_subjectExtendableLicense"] = EncodeRef[ExpandedlicensingExtendableLicense](self.expandedlicensingSubjectExtendableLicense.Get(), path.PushPath("expandedlicensingSubjectExtendableLicense"), expandedlicensingWithAdditionOperatorExpandedlicensingSubjectExtendableLicenseContext)
    }
    return nil
}
...
func (self ExtensionCdxPropertiesExtensionObjectType) Create() SHACLObject {
    return ConstructExtensionCdxPropertiesExtensionObject(&ExtensionCdxPropertiesExtensionObject{})
}

func ConstructExtensionCdxPropertiesExtensionObject(o *ExtensionCdxPropertiesExtensionObject) *ExtensionCdxPropertiesExtensionObject {
    ConstructExtensionExtensionObject(&o.ExtensionExtensionObject)
    {
...
func (self *ExtensionCdxPropertiesExtensionObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ExtensionExtensionObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.extensionCdxProperty.IsSet() {
        data["extension_cdxProperty"] = EncodeList[Ref[ExtensionCdxPropertyEntry]](self.extensionCdxProperty.Get(), path.PushPath("extensionCdxProperty"), extensionCdxPropertiesExtensionExtensionCdxPropertyContext, EncodeRef[ExtensionCdxPropertyEntry])
    }
    return nil
}
...
func (self SecurityCvssV2VulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecurityCvssV2VulnAssessmentRelationshipObject(&SecurityCvssV2VulnAssessmentRelationshipObject{})
}

func ConstructSecurityCvssV2VulnAssessmentRelationshipObject(o *SecurityCvssV2VulnAssessmentRelationshipObject) *SecurityCvssV2VulnAssessmentRelationshipObject {
    ConstructSecurityVulnAssessmentRelationshipObject(&o.SecurityVulnAssessmentRelationshipObject)
    {
        validators := []Validator[float64]{}
...
func (self *SecurityCvssV2VulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SecurityVulnAssessmentRelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.securityScore.IsSet() {
        data["security_score"] = EncodeFloat(self.securityScore.Get(), path.PushPath("securityScore"), securityCvssV2VulnAssessmentRelationshipSecurityScoreContext)
    }
    if self.securityVectorString.IsSet() {
        data["security_vectorString"] = EncodeString(self.securityVectorString.Get(), path.PushPath("securityVectorString"), securityCvssV2VulnAssessmentRelationshipSecurityVectorStringContext)
    }
    return nil
}
...
func (self SecurityCvssV3VulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecurityCvssV3VulnAssessmentRelationshipObject(&SecurityCvssV3VulnAssessmentRelationshipObject{})
}

func ConstructSecurityCvssV3VulnAssessmentRelationshipObject(o *SecurityCvssV3VulnAssessmentRelationshipObject) *SecurityCvssV3VulnAssessmentRelationshipObject {
    ConstructSecurityVulnAssessmentRelationshipObject(&o.SecurityVulnAssessmentRelationshipObject)
    {
        validators := []Validator[float64]{}
        o.securityScore = NewProperty[float64]("securityScore", validators)
...
func (self *SecurityCvssV3VulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SecurityVulnAssessmentRelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.securityScore.IsSet() {
        data["security_score"] = EncodeFloat(self.securityScore.Get(), path.PushPath("securityScore"), securityCvssV3VulnAssessmentRelationshipSecurityScoreContext)
    }
    if self.securitySeverity.IsSet() {
        data["security_severity"] = EncodeIRI(self.securitySeverity.Get(), path.PushPath("securitySeverity"), securityCvssV3VulnAssessmentRelationshipSecuritySeverityContext)
    }
    if self.securityVectorString.IsSet() {
        data["security_vectorString"] = EncodeString(self.securityVectorString.Get(), path.PushPath("securityVectorString"), securityCvssV3VulnAssessmentRelationshipSecurityVectorStringContext)
    }
    return nil
}
...
func (self SecurityCvssV4VulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecurityCvssV4VulnAssessmentRelationshipObject(&SecurityCvssV4VulnAssessmentRelationshipObject{})
}

func ConstructSecurityCvssV4VulnAssessmentRelationshipObject(o *SecurityCvssV4VulnAssessmentRelationshipObject) *SecurityCvssV4VulnAssessmentRelationshipObject {
    ConstructSecurityVulnAssessmentRelationshipObject(&o.SecurityVulnAssessmentRelationshipObject)
    {
        validators := []Validator[float64]{}
        o.securityScore = NewProperty[float64]("securityScore", validators)
...
func (self *SecurityCvssV4VulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SecurityVulnAssessmentRelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.securityScore.IsSet() {
        data["security_score"] = EncodeFloat(self.securityScore.Get(), path.PushPath("securityScore"), securityCvssV4VulnAssessmentRelationshipSecurityScoreContext)
    }
    if self.securitySeverity.IsSet() {
        data["security_severity"] = EncodeIRI(self.securitySeverity.Get(), path.PushPath("securitySeverity"), securityCvssV4VulnAssessmentRelationshipSecuritySeverityContext)
    }
    if self.securityVectorString.IsSet() {
        data["security_vectorString"] = EncodeString(self.securityVectorString.Get(), path.PushPath("securityVectorString"), securityCvssV4VulnAssessmentRelationshipSecurityVectorStringContext)
    }
    return nil
}
...
func (self SecurityEpssVulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecurityEpssVulnAssessmentRelationshipObject(&SecurityEpssVulnAssessmentRelationshipObject{})
}

func ConstructSecurityEpssVulnAssessmentRelationshipObject(o *SecurityEpssVulnAssessmentRelationshipObject) *SecurityEpssVulnAssessmentRelationshipObject {
    ConstructSecurityVulnAssessmentRelationshipObject(&o.SecurityVulnAssessmentRelationshipObject)
    {
        validators := []Validator[float64]{}
...
func (self *SecurityEpssVulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SecurityVulnAssessmentRelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.securityPercentile.IsSet() {
        data["security_percentile"] = EncodeFloat(self.securityPercentile.Get(), path.PushPath("securityPercentile"), securityEpssVulnAssessmentRelationshipSecurityPercentileContext)
    }
    if self.securityProbability.IsSet() {
        data["security_probability"] = EncodeFloat(self.securityProbability.Get(), path.PushPath("securityProbability"), securityEpssVulnAssessmentRelationshipSecurityProbabilityContext)
    }
    return nil
}
...
func (self SecurityExploitCatalogVulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecurityExploitCatalogVulnAssessmentRelationshipObject(&SecurityExploitCatalogVulnAssessmentRelationshipObject{})
}

func ConstructSecurityExploitCatalogVulnAssessmentRelationshipObject(o *SecurityExploitCatalogVulnAssessmentRelationshipObject) *SecurityExploitCatalogVulnAssessmentRelationshipObject {
    ConstructSecurityVulnAssessmentRelationshipObject(&o.SecurityVulnAssessmentRelationshipObject)
    {
        validators := []Validator[string]{}
        validators = append(validators,
...
func (self *SecurityExploitCatalogVulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SecurityVulnAssessmentRelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.securityCatalogType.IsSet() {
        data["security_catalogType"] = EncodeIRI(self.securityCatalogType.Get(), path.PushPath("securityCatalogType"), securityExploitCatalogVulnAssessmentRelationshipSecurityCatalogTypeContext)
    }
    if self.securityExploited.IsSet() {
        data["security_exploited"] = EncodeBoolean(self.securityExploited.Get(), path.PushPath("securityExploited"), securityExploitCatalogVulnAssessmentRelationshipSecurityExploitedContext)
    }
    if self.securityLocator.IsSet() {
        data["security_locator"] = EncodeString(self.securityLocator.Get(), path.PushPath("securityLocator"), securityExploitCatalogVulnAssessmentRelationshipSecurityLocatorContext)
    }
    return nil
}
...
func (self SecuritySsvcVulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecuritySsvcVulnAssessmentRelationshipObject(&SecuritySsvcVulnAssessmentRelationshipObject{})
}

func ConstructSecuritySsvcVulnAssessmentRelationshipObject(o *SecuritySsvcVulnAssessmentRelationshipObject) *SecuritySsvcVulnAssessmentRelationshipObject {
    ConstructSecurityVulnAssessmentRelationshipObject(&o.SecurityVulnAssessmentRelationshipObject)
    {
        validators := []Validator[string]{}
        validators = append(validators,
...
func (self *SecuritySsvcVulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SecurityVulnAssessmentRelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.securityDecisionType.IsSet() {
        data["security_decisionType"] = EncodeIRI(self.securityDecisionType.Get(), path.PushPath("securityDecisionType"), securitySsvcVulnAssessmentRelationshipSecurityDecisionTypeContext)
    }
    return nil
}
...
func (self SecurityVexVulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecurityVexVulnAssessmentRelationshipObject(&SecurityVexVulnAssessmentRelationshipObject{})
}

func ConstructSecurityVexVulnAssessmentRelationshipObject(o *SecurityVexVulnAssessmentRelationshipObject) *SecurityVexVulnAssessmentRelationshipObject {
    ConstructSecurityVulnAssessmentRelationshipObject(&o.SecurityVulnAssessmentRelationshipObject)
    {
        validators := []Validator[string]{}
...
func (self *SecurityVexVulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SecurityVulnAssessmentRelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.securityStatusNotes.IsSet() {
        data["security_statusNotes"] = EncodeString(self.securityStatusNotes.Get(), path.PushPath("securityStatusNotes"), securityVexVulnAssessmentRelationshipSecurityStatusNotesContext)
    }
    if self.securityVexVersion.IsSet() {
        data["security_vexVersion"] = EncodeString(self.securityVexVersion.Get(), path.PushPath("securityVexVersion"), securityVexVulnAssessmentRelationshipSecurityVexVersionContext)
    }
    return nil
}
...
func (self SecurityVulnerabilityObjectType) Create() SHACLObject {
    return ConstructSecurityVulnerabilityObject(&SecurityVulnerabilityObject{})
}

func ConstructSecurityVulnerabilityObject(o *SecurityVulnerabilityObject) *SecurityVulnerabilityObject {
    ConstructArtifactObject(&o.ArtifactObject)
    {
        validators := []Validator[time.Time]{}
        validators = append(validators, RegexValidator[time.Time]{`^\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\dZ$`})
        o.securityModifiedTime = NewProperty[time.Time]("securityModifiedTime", validators)
...
func (self *SecurityVulnerabilityObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ArtifactObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.securityModifiedTime.IsSet() {
        data["security_modifiedTime"] = EncodeDateTime(self.securityModifiedTime.Get(), path.PushPath("securityModifiedTime"), securityVulnerabilitySecurityModifiedTimeContext)
    }
    if self.securityPublishedTime.IsSet() {
        data["security_publishedTime"] = EncodeDateTime(self.securityPublishedTime.Get(), path.PushPath("securityPublishedTime"), securityVulnerabilitySecurityPublishedTimeContext)
    }
    if self.securityWithdrawnTime.IsSet() {
        data["security_withdrawnTime"] = EncodeDateTime(self.securityWithdrawnTime.Get(), path.PushPath("securityWithdrawnTime"), securityVulnerabilitySecurityWithdrawnTimeContext)
    }
    return nil
}
...
func (self SoftwareSoftwareArtifactObjectType) Create() SHACLObject {
    return ConstructSoftwareSoftwareArtifactObject(&SoftwareSoftwareArtifactObject{})
}

func ConstructSoftwareSoftwareArtifactObject(o *SoftwareSoftwareArtifactObject) *SoftwareSoftwareArtifactObject {
    ConstructArtifactObject(&o.ArtifactObject)
    {
        validators := []Validator[string]{}
        validators = append(validators,
...
func (self *SoftwareSoftwareArtifactObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ArtifactObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.softwareAdditionalPurpose.IsSet() {
        data["software_additionalPurpose"] = EncodeList[string](self.softwareAdditionalPurpose.Get(), path.PushPath("softwareAdditionalPurpose"), softwareSoftwareArtifactSoftwareAdditionalPurposeContext, EncodeIRI)
    }
    if self.softwareAttributionText.IsSet() {
        data["software_attributionText"] = EncodeList[string](self.softwareAttributionText.Get(), path.PushPath("softwareAttributionText"), softwareSoftwareArtifactSoftwareAttributionTextContext, EncodeString)
    }
    if self.softwareContentIdentifier.IsSet() {
        data["software_contentIdentifier"] = EncodeList[Ref[SoftwareContentIdentifier]](self.softwareContentIdentifier.Get(), path.PushPath("softwareContentIdentifier"), softwareSoftwareArtifactSoftwareContentIdentifierContext, EncodeRef[SoftwareContentIdentifier])
    }
    if self.softwareCopyrightText.IsSet() {
        data["software_copyrightText"] = EncodeString(self.softwareCopyrightText.Get(), path.PushPath("softwareCopyrightText"), softwareSoftwareArtifactSoftwareCopyrightTextContext)
    }
    if self.softwarePrimaryPurpose.IsSet() {
        data["software_primaryPurpose"] = EncodeIRI(self.softwarePrimaryPurpose.Get(), path.PushPath("softwarePrimaryPurpose"), softwareSoftwareArtifactSoftwarePrimaryPurposeContext)
    }
    return nil
}
...
func (self BomObjectType) Create() SHACLObject {
    return ConstructBomObject(&BomObject{})
}

func ConstructBomObject(o *BomObject) *BomObject {
    ConstructBundleObject(&o.BundleObject)
    return o
}
...
func (self *BomObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.BundleObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
}
...
func (self ExpandedlicensingCustomLicenseObjectType) Create() SHACLObject {
    return ConstructExpandedlicensingCustomLicenseObject(&ExpandedlicensingCustomLicenseObject{})
}

func ConstructExpandedlicensingCustomLicenseObject(o *ExpandedlicensingCustomLicenseObject) *ExpandedlicensingCustomLicenseObject {
    ConstructExpandedlicensingLicenseObject(&o.ExpandedlicensingLicenseObject)
    return o
}
...
func (self *ExpandedlicensingCustomLicenseObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.ExpandedlicensingLicenseObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
type SecurityVexAffectedVulnAssessmentRelationshipObject struct {
    ...
    securityActionStatementTime ListProperty[time.Time]
}
...
func (self SecurityVexAffectedVulnAssessmentRelationshipObjectType) DecodeProperty(o SHACLObject, name string, value interface{}, path Path) (bool, error) {
    ...
    case "https://spdx.org/rdf/3.0.1/terms/Security/actionStatementTime", "security_actionStatementTime":
        val, err := DecodeList[time.Time](value, path, securityVexAffectedVulnAssessmentRelationshipSecurityActionStatementTimeContext, DecodeDateTimeStamp)
        if err != nil {
            return false, err
        }
...
func (self SecurityVexAffectedVulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecurityVexAffectedVulnAssessmentRelationshipObject(&SecurityVexAffectedVulnAssessmentRelationshipObject{})
}

func ConstructSecurityVexAffectedVulnAssessmentRelationshipObject(o *SecurityVexAffectedVulnAssessmentRelationshipObject) *SecurityVexAffectedVulnAssessmentRelationshipObject {
    ConstructSecurityVexVulnAssessmentRelationshipObject(&o.SecurityVexVulnAssessmentRelationshipObject)
    {
        validators := []Validator[string]{}
    ...
    }
    {
        validators := []Validator[time.Time]{}
        validators = append(validators, RegexValidator[time.Time]{`^\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\dZ$`})
        o.securityActionStatementTime = NewListProperty[time.Time]("securityActionStatementTime", validators)
    }
    return o
}
...
type SecurityVexAffectedVulnAssessmentRelationship interface {
    ...
    SecurityActionStatementTime() ListPropertyInterface[time.Time]
}
...
func (self *SecurityVexAffectedVulnAssessmentRelationshipObject) SecurityActionStatementTime() ListPropertyInterface[time.Time] { return &self.securityActionStatementTime }

func (self *SecurityVexAffectedVulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SecurityVexVulnAssessmentRelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.securityActionStatement.IsSet() {
        data["security_actionStatement"] = EncodeString(self.securityActionStatement.Get(), path.PushPath("securityActionStatement"), securityVexAffectedVulnAssessmentRelationshipSecurityActionStatementContext)
    }
    if self.securityActionStatementTime.IsSet() {
        data["security_actionStatementTime"] = EncodeList[time.Time](self.securityActionStatementTime.Get(), path.PushPath("securityActionStatementTime"), securityVexAffectedVulnAssessmentRelationshipSecurityActionStatementTimeContext, EncodeDateTime)
    }
    return nil
}
...
func (self SecurityVexFixedVulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecurityVexFixedVulnAssessmentRelationshipObject(&SecurityVexFixedVulnAssessmentRelationshipObject{})
}

func ConstructSecurityVexFixedVulnAssessmentRelationshipObject(o *SecurityVexFixedVulnAssessmentRelationshipObject) *SecurityVexFixedVulnAssessmentRelationshipObject {
    ConstructSecurityVexVulnAssessmentRelationshipObject(&o.SecurityVexVulnAssessmentRelationshipObject)
    return o
}
...
func (self *SecurityVexFixedVulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SecurityVexVulnAssessmentRelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self SecurityVexNotAffectedVulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecurityVexNotAffectedVulnAssessmentRelationshipObject(&SecurityVexNotAffectedVulnAssessmentRelationshipObject{})
}

func ConstructSecurityVexNotAffectedVulnAssessmentRelationshipObject(o *SecurityVexNotAffectedVulnAssessmentRelationshipObject) *SecurityVexNotAffectedVulnAssessmentRelationshipObject {
    ConstructSecurityVexVulnAssessmentRelationshipObject(&o.SecurityVexVulnAssessmentRelationshipObject)
    {
        validators := []Validator[string]{}
...
func (self *SecurityVexNotAffectedVulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SecurityVexVulnAssessmentRelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.securityImpactStatement.IsSet() {
        data["security_impactStatement"] = EncodeString(self.securityImpactStatement.Get(), path.PushPath("securityImpactStatement"), securityVexNotAffectedVulnAssessmentRelationshipSecurityImpactStatementContext)
    }
    if self.securityImpactStatementTime.IsSet() {
        data["security_impactStatementTime"] = EncodeDateTime(self.securityImpactStatementTime.Get(), path.PushPath("securityImpactStatementTime"), securityVexNotAffectedVulnAssessmentRelationshipSecurityImpactStatementTimeContext)
    }
    if self.securityJustificationType.IsSet() {
        data["security_justificationType"] = EncodeIRI(self.securityJustificationType.Get(), path.PushPath("securityJustificationType"), securityVexNotAffectedVulnAssessmentRelationshipSecurityJustificationTypeContext)
    }
    return nil
}
...
func (self SecurityVexUnderInvestigationVulnAssessmentRelationshipObjectType) Create() SHACLObject {
    return ConstructSecurityVexUnderInvestigationVulnAssessmentRelationshipObject(&SecurityVexUnderInvestigationVulnAssessmentRelationshipObject{})
}

func ConstructSecurityVexUnderInvestigationVulnAssessmentRelationshipObject(o *SecurityVexUnderInvestigationVulnAssessmentRelationshipObject) *SecurityVexUnderInvestigationVulnAssessmentRelationshipObject {
    ConstructSecurityVexVulnAssessmentRelationshipObject(&o.SecurityVexVulnAssessmentRelationshipObject)
    return o
}
...
func (self *SecurityVexUnderInvestigationVulnAssessmentRelationshipObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SecurityVexVulnAssessmentRelationshipObject.EncodeProperties(data, path); err != nil {
        return err
    }
    return nil
...
func (self SoftwareFileObjectType) Create() SHACLObject {
    return ConstructSoftwareFileObject(&SoftwareFileObject{})
}

func ConstructSoftwareFileObject(o *SoftwareFileObject) *SoftwareFileObject {
    ConstructSoftwareSoftwareArtifactObject(&o.SoftwareSoftwareArtifactObject)
    {
        validators := []Validator[string]{}
        validators = append(validators, RegexValidator[string]{`^[^\/]+\/[^\/]+$`})
        o.contentType = NewProperty[string]("contentType", validators)
...
func (self *SoftwareFileObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SoftwareSoftwareArtifactObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.contentType.IsSet() {
        data["contentType"] = EncodeString(self.contentType.Get(), path.PushPath("contentType"), softwareFileContentTypeContext)
    }
    if self.softwareFileKind.IsSet() {
        data["software_fileKind"] = EncodeIRI(self.softwareFileKind.Get(), path.PushPath("softwareFileKind"), softwareFileSoftwareFileKindContext)
    }
    return nil
}
...
func (self SoftwarePackageObjectType) Create() SHACLObject {
    return ConstructSoftwarePackageObject(&SoftwarePackageObject{})
}

func ConstructSoftwarePackageObject(o *SoftwarePackageObject) *SoftwarePackageObject {
    ConstructSoftwareSoftwareArtifactObject(&o.SoftwareSoftwareArtifactObject)
    {
        validators := []Validator[string]{}
...
func (self *SoftwarePackageObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SoftwareSoftwareArtifactObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.softwareDownloadLocation.IsSet() {
        data["software_downloadLocation"] = EncodeString(self.softwareDownloadLocation.Get(), path.PushPath("softwareDownloadLocation"), softwarePackageSoftwareDownloadLocationContext)
    }
    if self.softwareHomePage.IsSet() {
        data["software_homePage"] = EncodeString(self.softwareHomePage.Get(), path.PushPath("softwareHomePage"), softwarePackageSoftwareHomePageContext)
    }
    if self.softwarePackageUrl.IsSet() {
        data["software_packageUrl"] = EncodeString(self.softwarePackageUrl.Get(), path.PushPath("softwarePackageUrl"), softwarePackageSoftwarePackageUrlContext)
    }
    if self.softwarePackageVersion.IsSet() {
        data["software_packageVersion"] = EncodeString(self.softwarePackageVersion.Get(), path.PushPath("softwarePackageVersion"), softwarePackageSoftwarePackageVersionContext)
    }
    if self.softwareSourceInfo.IsSet() {
        data["software_sourceInfo"] = EncodeString(self.softwareSourceInfo.Get(), path.PushPath("softwareSourceInfo"), softwarePackageSoftwareSourceInfoContext)
    }
    return nil
}
...
func (self SoftwareSbomObjectType) Create() SHACLObject {
    return ConstructSoftwareSbomObject(&SoftwareSbomObject{})
}

func ConstructSoftwareSbomObject(o *SoftwareSbomObject) *SoftwareSbomObject {
    ConstructBomObject(&o.BomObject)
    {
        validators := []Validator[string]{}
        validators = append(validators,
            EnumValidator{[]string{
...
func (self *SoftwareSbomObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.BomObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.softwareSbomType.IsSet() {
        data["software_sbomType"] = EncodeList[string](self.softwareSbomType.Get(), path.PushPath("softwareSbomType"), softwareSbomSoftwareSbomTypeContext, EncodeIRI)
    }
    return nil
}
...
func (self SoftwareSnippetObjectType) Create() SHACLObject {
    return ConstructSoftwareSnippetObject(&SoftwareSnippetObject{})
}

func ConstructSoftwareSnippetObject(o *SoftwareSnippetObject) *SoftwareSnippetObject {
    ConstructSoftwareSoftwareArtifactObject(&o.SoftwareSoftwareArtifactObject)
    {
...
func (self *SoftwareSnippetObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SoftwareSoftwareArtifactObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.softwareByteRange.IsSet() {
        data["software_byteRange"] = EncodeRef[PositiveIntegerRange](self.softwareByteRange.Get(), path.PushPath("softwareByteRange"), softwareSnippetSoftwareByteRangeContext)
    }
    if self.softwareLineRange.IsSet() {
        data["software_lineRange"] = EncodeRef[PositiveIntegerRange](self.softwareLineRange.Get(), path.PushPath("softwareLineRange"), softwareSnippetSoftwareLineRangeContext)
    }
    if self.softwareSnippetFromFile.IsSet() {
        data["software_snippetFromFile"] = EncodeRef[SoftwareFile](self.softwareSnippetFromFile.Get(), path.PushPath("softwareSnippetFromFile"), softwareSnippetSoftwareSnippetFromFileContext)
    }
    return nil
}
...
func (self AiAIPackageObjectType) Create() SHACLObject {
    return ConstructAiAIPackageObject(&AiAIPackageObject{})
}

func ConstructAiAIPackageObject(o *AiAIPackageObject) *AiAIPackageObject {
    ConstructSoftwarePackageObject(&o.SoftwarePackageObject)
    {
        validators := []Validator[string]{}
        validators = append(validators,
            EnumValidator{[]string{
...
func (self *AiAIPackageObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SoftwarePackageObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.aiAutonomyType.IsSet() {
        data["ai_autonomyType"] = EncodeIRI(self.aiAutonomyType.Get(), path.PushPath("aiAutonomyType"), aiAIPackageAiAutonomyTypeContext)
    }
    if self.aiDomain.IsSet() {
        data["ai_domain"] = EncodeList[string](self.aiDomain.Get(), path.PushPath("aiDomain"), aiAIPackageAiDomainContext, EncodeString)
    }
    if self.aiEnergyConsumption.IsSet() {
        data["ai_energyConsumption"] = EncodeRef[AiEnergyConsumption](self.aiEnergyConsumption.Get(), path.PushPath("aiEnergyConsumption"), aiAIPackageAiEnergyConsumptionContext)
    }
    if self.aiHyperparameter.IsSet() {
        data["ai_hyperparameter"] = EncodeList[Ref[DictionaryEntry]](self.aiHyperparameter.Get(), path.PushPath("aiHyperparameter"), aiAIPackageAiHyperparameterContext, EncodeRef[DictionaryEntry])
    }
    if self.aiInformationAboutApplication.IsSet() {
        data["ai_informationAboutApplication"] = EncodeString(self.aiInformationAboutApplication.Get(), path.PushPath("aiInformationAboutApplication"), aiAIPackageAiInformationAboutApplicationContext)
    }
    if self.aiInformationAboutTraining.IsSet() {
        data["ai_informationAboutTraining"] = EncodeString(self.aiInformationAboutTraining.Get(), path.PushPath("aiInformationAboutTraining"), aiAIPackageAiInformationAboutTrainingContext)
    }
    if self.aiLimitation.IsSet() {
        data["ai_limitation"] = EncodeString(self.aiLimitation.Get(), path.PushPath("aiLimitation"), aiAIPackageAiLimitationContext)
    }
    if self.aiMetric.IsSet() {
        data["ai_metric"] = EncodeList[Ref[DictionaryEntry]](self.aiMetric.Get(), path.PushPath("aiMetric"), aiAIPackageAiMetricContext, EncodeRef[DictionaryEntry])
    }
    if self.aiMetricDecisionThreshold.IsSet() {
        data["ai_metricDecisionThreshold"] = EncodeList[Ref[DictionaryEntry]](self.aiMetricDecisionThreshold.Get(), path.PushPath("aiMetricDecisionThreshold"), aiAIPackageAiMetricDecisionThresholdContext, EncodeRef[DictionaryEntry])
    }
    if self.aiModelDataPreprocessing.IsSet() {
        data["ai_modelDataPreprocessing"] = EncodeList[string](self.aiModelDataPreprocessing.Get(), path.PushPath("aiModelDataPreprocessing"), aiAIPackageAiModelDataPreprocessingContext, EncodeString)
    }
    if self.aiModelExplainability.IsSet() {
        data["ai_modelExplainability"] = EncodeList[string](self.aiModelExplainability.Get(), path.PushPath("aiModelExplainability"), aiAIPackageAiModelExplainabilityContext, EncodeString)
    }
    if self.aiSafetyRiskAssessment.IsSet() {
        data["ai_safetyRiskAssessment"] = EncodeIRI(self.aiSafetyRiskAssessment.Get(), path.PushPath("aiSafetyRiskAssessment"), aiAIPackageAiSafetyRiskAssessmentContext)
    }
    if self.aiStandardCompliance.IsSet() {
        data["ai_standardCompliance"] = EncodeList[string](self.aiStandardCompliance.Get(), path.PushPath("aiStandardCompliance"), aiAIPackageAiStandardComplianceContext, EncodeString)
    }
    if self.aiTypeOfModel.IsSet() {
        data["ai_typeOfModel"] = EncodeList[string](self.aiTypeOfModel.Get(), path.PushPath("aiTypeOfModel"), aiAIPackageAiTypeOfModelContext, EncodeString)
    }
    if self.aiUseSensitivePersonalInformation.IsSet() {
        data["ai_useSensitivePersonalInformation"] = EncodeIRI(self.aiUseSensitivePersonalInformation.Get(), path.PushPath("aiUseSensitivePersonalInformation"), aiAIPackageAiUseSensitivePersonalInformationContext)
    }
    return nil
}
...
func (self DatasetDatasetPackageObjectType) Create() SHACLObject {
    return ConstructDatasetDatasetPackageObject(&DatasetDatasetPackageObject{})
}

func ConstructDatasetDatasetPackageObject(o *DatasetDatasetPackageObject) *DatasetDatasetPackageObject {
    ConstructSoftwarePackageObject(&o.SoftwarePackageObject)
    {
        validators := []Validator[string]{}
...
func (self *DatasetDatasetPackageObject) EncodeProperties(data map[string]interface{}, path Path) error {
    if err := self.SoftwarePackageObject.EncodeProperties(data, path); err != nil {
        return err
    }
    if self.datasetAnonymizationMethodUsed.IsSet() {
        data["dataset_anonymizationMethodUsed"] = EncodeList[string](self.datasetAnonymizationMethodUsed.Get(), path.PushPath("datasetAnonymizationMethodUsed"), datasetDatasetPackageDatasetAnonymizationMethodUsedContext, EncodeString)
    }
    if self.datasetConfidentialityLevel.IsSet() {
        data["dataset_confidentialityLevel"] = EncodeIRI(self.datasetConfidentialityLevel.Get(), path.PushPath("datasetConfidentialityLevel"), datasetDatasetPackageDatasetConfidentialityLevelContext)
    }
    if self.datasetDataCollectionProcess.IsSet() {
        data["dataset_dataCollectionProcess"] = EncodeString(self.datasetDataCollectionProcess.Get(), path.PushPath("datasetDataCollectionProcess"), datasetDatasetPackageDatasetDataCollectionProcessContext)
    }
    if self.datasetDataPreprocessing.IsSet() {
        data["dataset_dataPreprocessing"] = EncodeList[string](self.datasetDataPreprocessing.Get(), path.PushPath("datasetDataPreprocessing"), datasetDatasetPackageDatasetDataPreprocessingContext, EncodeString)
    }
    if self.datasetDatasetAvailability.IsSet() {
        data["dataset_datasetAvailability"] = EncodeIRI(self.datasetDatasetAvailability.Get(), path.PushPath("datasetDatasetAvailability"), datasetDatasetPackageDatasetDatasetAvailabilityContext)
    }
    if self.datasetDatasetNoise.IsSet() {
        data["dataset_datasetNoise"] = EncodeString(self.datasetDatasetNoise.Get(), path.PushPath("datasetDatasetNoise"), datasetDatasetPackageDatasetDatasetNoiseContext)
    }
    if self.datasetDatasetSize.IsSet() {
        data["dataset_datasetSize"] = EncodeInteger(self.datasetDatasetSize.Get(), path.PushPath("datasetDatasetSize"), datasetDatasetPackageDatasetDatasetSizeContext)
    }
    if self.datasetDatasetType.IsSet() {
        data["dataset_datasetType"] = EncodeList[string](self.datasetDatasetType.Get(), path.PushPath("datasetDatasetType"), datasetDatasetPackageDatasetDatasetTypeContext, EncodeIRI)
    }
    if self.datasetDatasetUpdateMechanism.IsSet() {
        data["dataset_datasetUpdateMechanism"] = EncodeString(self.datasetDatasetUpdateMechanism.Get(), path.PushPath("datasetDatasetUpdateMechanism"), datasetDatasetPackageDatasetDatasetUpdateMechanismContext)
    }
    if self.datasetHasSensitivePersonalInformation.IsSet() {
        data["dataset_hasSensitivePersonalInformation"] = EncodeIRI(self.datasetHasSensitivePersonalInformation.Get(), path.PushPath("datasetHasSensitivePersonalInformation"), datasetDatasetPackageDatasetHasSensitivePersonalInformationContext)
    }
    if self.datasetIntendedUse.IsSet() {
        data["dataset_intendedUse"] = EncodeString(self.datasetIntendedUse.Get(), path.PushPath("datasetIntendedUse"), datasetDatasetPackageDatasetIntendedUseContext)
    }
    if self.datasetKnownBias.IsSet() {
        data["dataset_knownBias"] = EncodeList[string](self.datasetKnownBias.Get(), path.PushPath("datasetKnownBias"), datasetDatasetPackageDatasetKnownBiasContext, EncodeString)
    }
    if self.datasetSensor.IsSet() {
        data["dataset_sensor"] = EncodeList[Ref[DictionaryEntry]](self.datasetSensor.Get(), path.PushPath("datasetSensor"), datasetDatasetPackageDatasetSensorContext, EncodeRef[DictionaryEntry])
    }
    return nil
}
...
func init() {
    ...
    httpSpdxInvalidAbstractClassType = HttpSpdxInvalidAbstractClassObjectType{
        SHACLTypeBase: SHACLTypeBase{
            typeIRI: "http://spdx.invalid./AbstractClass",
            isAbstract: false,
    ...
    RegisterType(httpSpdxInvalidAbstractClassType)
