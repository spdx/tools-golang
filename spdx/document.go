...
type Document2_1 struct {
	...
	ExternalDocumentReferences []ExternalDocumentRef2_1 `json:"externalDocumentRefs"`
...
type Document2_2 struct {
	...
	// 2.6: External Document References
	// Cardinality: optional, one or many
	ExternalDocumentReferences []ExternalDocumentRef2_2 `json:"externalDocumentRefs"`
