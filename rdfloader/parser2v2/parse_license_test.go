...
func Test_rdfParser2_2_getAnyLicenseFromNode(t *testing.T) {
	...
	parser, _ = parserFromBodyContent(`
			<spdx:ExtractedLicensingInfo rdf:about="https://spdx.dev/spdx.rdf#LicenseRef-Freeware">
	...
	// TestCase 5: License
	parser, _ = parserFromBodyContent(`
							<spdx:License rdf:about="https://spdx.org/licenses/Apache-2.0">
	...
	parser, _ = parserFromBodyContent(`
			<spdx:WithExceptionOperator>
				...
				<spdx:member rdf:resource="https://spdx.org/licenses/GPL-2.0-or-later"/>
			</spdx:WithExceptionOperator>
		`)
	inputNode = parser.gordfParserObj.Triples[0].Subject
	lic, err = parser.getAnyLicenseFromNode(inputNode)
	...
	parser, _ = parserFromBodyContent(`
					<spdx:ConjunctiveLicenseSet rdf:about="#SPDXRef-RecursiveLicense">
						...
						<spdx:member>
							<spdx:ConjunctiveLicenseSet rdf:about="#SPDXRef-RecursiveLicense">
								<spdx:member rdf:resource="https://spdx.org/licenses/LGPL-2.0"/>
								<spdx:member rdf:resource="https://spdx.org/spdxdocs/spdx-example-444504E0-4F89-41D3-9A0C-0305E82C3301#SPDXRef-RecursiveLicense"/>
							</spdx:ConjunctiveLicenseSet>
						</spdx:member>
					</spdx:ConjunctiveLicenseSet>
				`)
